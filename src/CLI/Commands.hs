      ...
      case storeResult of
        ...
        Right store -> do
          let targetGen = targetGeneration rollbackOpts
              rollbackOptions' = Mycfg.Core.Rollback.RollbackOptions
            ...
            Right config -> do
              ...
              case validationResult of
                ValidationSuccess warnings -> do
                  let warningText = if null warnings && showWarnings'
              ...
              case genResult of
                ...
                Right generations -> do
                  let genList = map (generationId . metadata) generations
                      output = if showDetails listOpts
          ...
          case parseResult of
            ...
            Right config -> do
              ...
              case validationResult of
                ...
                ValidationSuccess warnings -> do
                  let warningText = if null warnings
...
handleHelp logger options = do
  withOperation logger $ \opCtx -> do
    logInfo opCtx "Showing help" $ do
      let helpText = "mycfg - Declarative Configuration Manager\n\n" <>
                   "Commands:\n" <>
