...
showConfigurationHelp = Text.unlines
  [ "CONFIGURATION"
  , ""
...
showTroubleshootingHelp = Text.unlines
  [ "TROUBLESHOOTING"
  , ""
  , "COMMON ISSUES:"
  , ""
