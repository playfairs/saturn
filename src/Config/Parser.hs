...
systemCodec = SystemConfig
  <$> Toml.text `Toml.dioptional` .= hostname
  <*> Toml.text `Toml.dioptional` .= timezone
  <*> Toml.text `Toml.dioptional` .= locale
  <*> Toml.text `Toml.dioptional` .= shell
  <*> Toml.text `Toml.dioptional` .= editor

packageCodec :: TomlCodec PackageConfig
packageCodec = PackageConfig
  <$> Toml.list Toml.text `Toml.dioptional` .= cli
  <*> Toml.list Toml.text `Toml.dioptional` .= gui
  <*> Toml.list Toml.text `Toml.dioptional` .= development
  <*> Toml.list Toml.text `Toml.dioptional` .= system

serviceCodec :: TomlCodec ServiceConfig
serviceCodec = ServiceConfig
  <*> Toml.bool .= enable
  <*> Toml.bool .= start
  <*> Toml.tableMap Toml.text Toml.text `Toml.dioptional` .= config

profileCodec :: TomlCodec ProfileConfig
profileCodec = ProfileConfig
  <$> Toml.text .= name
  <*> Toml.text .= description
  <*> Toml.list Toml.text .= modules
  <*> Toml.list Toml.text `Toml.dioptional` .= extends
