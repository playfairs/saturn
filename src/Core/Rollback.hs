...
createRollbackError context errors = RollbackResult
  { success = False
  , rolledBackSteps = 0
...
createRollbackErrorFromStore errors fromGen toGen = RollbackResult
  { success = False
  , rolledBackSteps = 0
  , failedSteps = length errors
  , duration = 0
