...
import System.Directory (executable, getPermissions, readable, searchable, setPermissions, writable)
import System.Posix.Files (FileMode, fileMode, getFileStatus, groupExecuteMode, groupReadMode, groupWriteMode, intersectFileModes, nullFileMode, otherExecuteMode, otherReadMode, otherWriteMode, ownerExecuteMode, ownerReadMode, ownerWriteMode, setFileMode, unionFileModes)
