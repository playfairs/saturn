...
import System.Directory (createDirectoryLink, createFileLink, removeFile, doesFileExist, doesDirectoryExist, getDirectoryContents, canonicalizePath)
import System.FilePath ((</>), takeDirectory, takeFileName)
import System.Posix.Files (createSymbolicLink, readSymbolicLink, isSymbolicLink, getFileStatus, fileMode)
...
atomicSymlinkReplace targetPath linkPath = do
  ...
  if exists
    ...
    else createSymlink targetPath linkPath >>= \case
