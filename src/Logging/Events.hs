...
instance ToJSON LogEvent where
  toJSON event = case event of
    ...
    ValidationStarted{..} -> object
      [ "type" .= ("validation_started" :: Text)
      , "operation_id" .= operationId
      , "timestamp" .= timestamp
      ]
    
    ValidationCompleted{..} -> object
    ...
    DependencyResolutionStarted{..} -> object
      [ "type" .= ("dependency_resolution_started" :: Text)
      , "operation_id" .= operationId
      , "timestamp" .= timestamp
      ]
    
    DependencyResolutionCompleted{..} -> object
    ...
    DependencyResolutionFailed{..} -> object
    ...
    PlanningStarted{..} -> object
      [ "type" .= ("planning_started" :: Text)
      , "operation_id" .= operationId
      , "timestamp" .= timestamp
      ]
    
    PlanningCompleted{..} -> object
    ...
    StateCorruptionDetected{..} -> object
