...
import System.IO (Handle, IOMode (ReadWriteMode), hClose, hFlush, hPutStr, openFile)
import System.Posix.Files (fileMode, getFileStatus, ownerReadMode, ownerWriteMode, setFileMode)
